#Apart from these three lines of comments, this code is completely unaltered from what was used originally for the hackathon.
#This code is extremely unorganized, inefficient, and bad, but I thought it would be nice to include to see the progress.
#This was made as I was still learning the basics of python. I had only been just introduced a few months ealier, and had no idea about classes.
